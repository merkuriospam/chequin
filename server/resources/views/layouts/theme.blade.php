...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{ asset('theme/css/new-age.min.css') }}" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">CheQuin</a>
    ...
    <footer>
      <div class="container">
        <p>&copy; CheQuin {{ date('Y') }} - Todos los derechos reservados.</p>
    ...
    <script src="{{ asset('theme/js/new-age.min.js') }}"></script>
